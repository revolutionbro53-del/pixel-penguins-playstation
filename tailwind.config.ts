    ...
    extend: {
      ...
      colors: {
        ...
        ps: {
          ...
          neon: "hsl(var(--ps-neon))",
          gold: "hsl(var(--ps-gold))",
          success: "hsl(var(--ps-success))",
          surface: "hsl(var(--ps-surface))",
          surface2: "hsl(var(--ps-surface-2))",
          border: "hsl(var(--ps-border))",
          secondary: "hsl(var(--ps-text-secondary))",
        },
        sidebar: {
